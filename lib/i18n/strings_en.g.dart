...
class Translations with BaseTranslations<AppLocale, Translations> {
	...
	/// en: 'History backups'
	String get syncHistory => 'History backups';

	/// en: 'No history backups'
	String get syncHistoryEmpty => 'No history backups';
	...
	/// en: 'Dice library'
	String get storyDiceLibrary => 'Dice library';
	...
	/// en: 'Generating ${done}/${total}'
	String loreTriggerGenProgress({required Object done, required Object total}) => 'Generating ${done}/${total}';
	...
	/// en: 'Bound to source'
	String get textRuleBoundOnly => 'Bound to source';
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'textRuleBoundOnly' => 'Bound to source',
