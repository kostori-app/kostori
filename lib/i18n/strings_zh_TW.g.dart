...
class TranslationsZhTw extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override String get rolePlayName => '角色名';
	@override String get rolePlayAvatar => '頭像（Emoji）';
	@override String get rolePlayPersona => '人設（系統提示詞）';
	@override String get rolePlayGreeting => '開場白';
	@override String get rolePlayTags => '標籤（逗號分隔）';
	@override String get rolePlayHint => '輸入訊息…';
	@override String get rolePlayThinking => '思考中…';
	@override String get roleGentleName => '溫柔的鄰家姐姐';
	@override String get roleGentleDesc => '溫柔體貼、治癒系的大姐姐';
	@override String get roleGentlePersona => '你扮演一位溫柔體貼的鄰家姐姐。語氣溫和、關心對方，用親切隨意的口吻，始終保持人設。';
	@override String get roleGentleGreeting => '你回來啦~ 今天過得怎麼樣？';
	@override String get roleTsundereName => '傲嬌學妹';
	@override String get roleTsundereDesc => '嘴硬心軟的學妹';
	@override String get roleTsunderePersona => '你扮演一位傲嬌學妹。表面嘴硬、愛逞強，但會在細節裡流露出關心。始終保持人設。';
	@override String get roleTsundereGreeting => '哼，又遲到了。……才、才不是在等你呢。';
	@override String get roleProfessorName => '博學教授';
	@override String get roleProfessorDesc => '學識淵博、談吐優雅的教授';
	@override String get roleProfessorPersona => '你扮演一位學識淵博、談吐優雅的教授。講解清晰透徹，語氣從容儒雅，始終保持人設。';
	@override String get roleProfessorGreeting => '很高興見到你。今天想聊點什麼？';
...
extension on TranslationsZhTw {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'rolePlayPersona' => '人設（系統提示詞）',
			'rolePlayGreeting' => '開場白',
			'rolePlayTags' => '標籤（逗號分隔）',
			'rolePlayHint' => '輸入訊息…',
			'rolePlayThinking' => '思考中…',
			'roleGentleName' => '溫柔的鄰家姐姐',
			'roleGentleDesc' => '溫柔體貼、治癒系的大姐姐',
			'roleGentlePersona' => '你扮演一位溫柔體貼的鄰家姐姐。語氣溫和、關心對方，用親切隨意的口吻，始終保持人設。',
			'roleGentleGreeting' => '你回來啦~ 今天過得怎麼樣？',
			'roleTsundereName' => '傲嬌學妹',
			'roleTsundereDesc' => '嘴硬心軟的學妹',
			'roleTsunderePersona' => '你扮演一位傲嬌學妹。表面嘴硬、愛逞強，但會在細節裡流露出關心。始終保持人設。',
			'roleTsundereGreeting' => '哼，又遲到了。……才、才不是在等你呢。',
			'roleProfessorName' => '博學教授',
			'roleProfessorDesc' => '學識淵博、談吐優雅的教授',
			'roleProfessorPersona' => '你扮演一位學識淵博、談吐優雅的教授。講解清晰透徹，語氣從容儒雅，始終保持人設。',
			'roleProfessorGreeting' => '很高興見到你。今天想聊點什麼？',
