...
class TranslationsZhCn extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override String fullBEpisodesReleased({required Object b}) => '全 ${b} 话已发布';
	@override String upToEpSTotalEpsPlanned({required Object s, required Object t}) => '更新至第 ${s} 话 • 计划全 ${t} 话';
	@override String upToEpETotalEpsPlanned({required Object e, required Object s, required Object t}) => '更新至第 ${e} 话 (${s}) • 计划全 ${t} 话';
...
extension on TranslationsZhCn {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'upToEpSTotalEpsPlanned' => ({required Object s, required Object t}) => '更新至第 ${s} 话 • 计划全 ${t} 话',
			'upToEpETotalEpsPlanned' => ({required Object e, required Object s, required Object t}) => '更新至第 ${e} 话 (${s}) • 计划全 ${t} 话',
