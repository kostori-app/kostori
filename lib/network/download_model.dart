...
import '../tools/io_extensions.dart';
import 'app_dio.dart';
...
enum DownloadType {
  ...
  // AnimeType toAnimeType() => switch (this) {
  //       picacg => AnimeType.picacg,
  //       ehentai => AnimeType.ehentai,
  //       jm => AnimeType.jm,
  //       hitomi => AnimeType.hitomi,
  //       htmanga => AnimeType.htManga,
  //       nhentai => AnimeType.nhentai,
  //       other => AnimeType.other,
  //       favorite => AnimeType.other,
  //     };
}
...
abstract class DownloadingItem with _TransferSpeedMixin {
  ...
  //         "下载中", "${downloadManager.downloading.length} Tasks");
  //
