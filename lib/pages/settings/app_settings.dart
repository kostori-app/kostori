...
//   context.showMessage(message: "正在检查更新");
//   checkUpdate().then((b) {
//     if (!context.mounted) return;
//     if (b == null) {
//       context.showMessage(message: "暂时没有捏");
//     } else if (b) {
...
//                   actions: [
//                     TextButton(
//                         onPressed: () => App.globalBack(), child: Text("取消")),
//                     TextButton(
//                         onPressed: () {
...
//               });
//         } else {
//           context.showMessage(message: "网络错误");
//         }
//       });
//     } else {
//       context.showMessage(message: "已是最新版本");
//     }
//   });
// }
//
...
//   //   showToast(message: "请在下载任务完成后进行操作");
//   //   return;
//   // }
//
//   if (App.isAndroid) {
...
//     var havePermission = await const MethodChannel("kostori/settings")
...
//                       Expanded(
//                         child: SizedBox(
//                           child: Text("如需还原之前的下载, 将路径填写为下载数据的位置, 并取消勾选转移数据"),
//                         ),
//                       )
//                     ],
//                   ),
...
//                   child: ListTile(
//                     title: Text("允许储存权限"),
//                     subtitle: Text("需要储存权限以选取任意目录"),
//                     onTap: () {
//                       const MethodChannel("kostori/settings")
//                           .invokeMethod("files");
//                       App.globalBack();
//                     },
//                   ),
...
//     var widget = ListTile(title: Text(i), key: Key(i));
//     return InkWell(
//       child: widget,
//       onTap: () {
//         App.back(context);
...
//             title: Text("警告"),
//             content: Text("此操作无法撤销, 是否继续"),
//             actions: [
//               TextButton(onPressed: () => App.globalBack(), child: Text("取消")),
//               TextButton(
//                   onPressed: () async {
//                     await clearAppdata();
...
//       if (res) {
//         dialog.close();
//         showToast(message: "成功导出");
//       } else {
//         dialog.close();
//         showToast(message: "导出失败");
//       }
//     }
//   }
//
...
//       builder: (context) => AlertDialog(
//             title: Text("导出用户数据"),
//             content: Text("将导出设置, 账号, 历史记录, 下载内容, 本地收藏等数据"),
//             actions: [
//               TextButton(onPressed: () => App.globalBack(), child: Text("取消")),
//               TextButton(
//                   onPressed: () {
...
//       builder: (context) => AlertDialog(
//             title: Text("导入用户数据"),
//             content: Text("${"将导入设置, 账号, 历史记录, 下载内容, 本地收藏等数据, 现在的所有数据将会被覆盖"}"
//                 "\n${"如果导入的数据中包含下载数据, 则当前的下载数据也将被覆盖"}"),
//             actions: [
//               TextButton(onPressed: () => App.globalBack(), child: Text("取消")),
//               TextButton(
//                   onPressed: () {
...
//                   width: 4,
//                 ),
//                 if (configs.length == 4) Text("将URL留空以禁用同步") else Text("已禁用")
//               ],
//             ),
//           )
//         ],
