          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                const SizedBox(height: 16),
                _card(context, t.builderExplore, Icons.explore_outlined, [
                  _field(_exploreTitleCtrl, t.builderExploreTitle),
                  const SizedBox(height: 12),
                  _field(_exploreUrlCtrl, t.builderExploreUrl),
                ], code: _buildExploreJs()),
                const SizedBox(height: 16),
                _card(context, t.builderCategory, Icons.category_outlined, [
                ...
                const SizedBox(height: 16),
                _card(context, t.builderDetail, Icons.article_outlined, [
                  ...
                  const SizedBox(height: 12),
                  _field(_detailEpTitleSelCtrl, t.builderEpisodeTitleSelector),
                  const SizedBox(height: 12),
                  _field(_detailEpLinkSelCtrl, t.builderEpisodeLinkSelector),
                ], code: _buildDetailJs()),
                const SizedBox(height: 16),
                _card(context, t.builderPlay, Icons.play_circle_outline, [
                  SwitchListTile(
