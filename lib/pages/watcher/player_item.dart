...
class _PlayerItemState extends State<PlayerItem>
  ...
  Future<void> increaseVolume() async {
    await widget.playerController
        .setVolume(widget.playerController.volume + 10);
  }
                                  ...
                                  child: GestureDetector(
                                    ...
                                    onVerticalDragUpdate:
                                      ...
                                      if (tapPosition < sectionWidth) {
                                        ...
                                        widget.playerController.showBrightness =
                                            true;
                                        ...
                                        // 右边区域
                                        widget.playerController.volumeSeeking =
                                            true;
                                        widget.playerController.showVolume =
                                            true;
                                        final double level =
                                            (totalHeight) * 0.03;
                                        final double volume =
                                    ...
                                    onVerticalDragEnd: (_) {
                                      if (widget
                                          .playerController.volumeSeeking) {
                                        widget.playerController.volumeSeeking =
                                            false;
                                        Future.delayed(
