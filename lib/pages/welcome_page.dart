            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  ...
                  image: const DecorationImage(
                      image: AssetImage("images/app_icon2.png"),
...
class _AppInfoState extends State<_AppInfo> with _WelcomePageComponents {
  ...
  Widget build(BuildContext context) {
    var style =
        context.width > 500 ? ts.s16.withHeight(2) : ts.s14.withHeight(1.6);
    return buildView(
      children: [
        buildTitle("使用须知"),
        Text(
  ...
  String buildInfo() {
    ...
    content += "感谢使用本软件, 请注意:";
    content += '\n';
    content += "本App的开发目的仅为学习交流与个人兴趣, 显示的任何内容均来自网络, 与开发者无关";
    content += '\n';
    content += "如果在使用中发现问题, 请先确认是否为自己的设备问题, 然后再进行反馈";
    content += '\n';
    content += "开发者不对能否解决问题负责";
    return content;
  }
}
...
//               appdata.updateSettings();
//             }),
//         Text("滑动到底部时自动加载下一页并追加到页面末尾").paddingHorizontal(16),
//         const SizedBox(
//           height: 16,
//         ),
//         RadioListTile<int>(
...
//               appdata.updateSettings();
//             }),
//         Text("需要手动切换页面").paddingHorizontal(16),
//         const Spacer(),
...
//               return ListTile(
//                 title: Text(
//                     AnimeSource.builtIn.firstWhere((e) => e.key == key).name),
//                 trailing: Switch(
