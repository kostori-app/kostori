    ...
    builder: (context) {
      ...
      return StatefulBuilder(builder: (context, setState) {
        return ContentDialog(
          title: "Remove".tl,
          content: Text("Remove anime from favorite?".tl).paddingHorizontal(16),
          actions: [
            Button.filled(
              isLoading: loading,
...
class _NormalFavoritePageState extends State<_NormalFavoritePage> {
  final animeListKey = GlobalKey<AnimeListState>();
  ...
  Widget build(BuildContext context) {
    return AnimeList(
      ...
      loadPage: widget.data.loadAnime == null
          ? null
          : (i) => widget.data.loadAnime!(i),
        ...
        return [
          MenuEntry(
            ...
            onClick: () async {
              ...
              if (res) {
                animeListKey.currentState!.remove(anime);
              }
            },
          ),
        ];
...
class _FavoriteFolder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AnimeList(
      ...
      loadPage:
          data.loadAnime == null ? null : (i) => data.loadAnime!(i, folderID),
